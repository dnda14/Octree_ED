...
\begin{enumerate}
    ...
    \item \textbf{Búsqueda en los Puntos del Nodo:} Si el punto está dentro de los límites, se busca directamente en la lista de puntos del nodo.\text{Si el punto se encuentra en la lista de puntos, se retorna \texttt{True}.}
    
    
    \item \textbf{Búsqueda Recursiva en los Nodos Hijos:} Si el nodo está dividido (es decir, tiene hijos), se busca recursivamente en cada hijo.\text{Si el punto es encontrado en algún hijo, se retorna \texttt{True}.}
